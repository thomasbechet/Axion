...
namespace ax
{
    ...
    class AXION_GL_API RendererModuleGL : public RendererModule
    {
    public:
        ...
        //Viewport
        RendererGUIViewportHandle createViewport(const Rectf& viewport, const Vector2u& resolution, RenderMode mode = RenderMode::Default) override;
