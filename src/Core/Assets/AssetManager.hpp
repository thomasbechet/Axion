...
namespace ax
{
    ...
    public:
        ...
        bool load(Path path) noexcept;
        bool unload(std::string name) noexcept;
        std::shared_ptr<const Package> get(std::string name) const noexcept;
        ...
        bool loadMaterial(std::string name, const MaterialParameters& material) noexcept;
